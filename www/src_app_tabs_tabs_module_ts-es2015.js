...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'match',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_match_match_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ../match/match.module */ 28686)).then(m => m.MatchPageModule)
            },
            {
                path: '',
