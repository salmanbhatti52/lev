(function () {
  ...
  (self["webpackChunklev"] = self["webpackChunklev"] || []).push([["src_app_match_match_module_ts"], {
      ...
      var _MatchPage = /*#__PURE__*/function () {
        ...
        _createClass(MatchPage, [{
          ...
          value: function goToMessage(match) {
            ...
            this.router.navigate(['otherprofile']); // } else {
          ...
          value: function closeMatch() {
            ...
            this.restService.delete_matchAPI(ss).subscribe(function (res) {
              ...
              if (res.status.success) {
                ...
                _this2.matches.splice(_this2.selectedIndexToDelete, 1);

                _this2.totalMatches = _this2.totalMatches - 1;
              } else {
                _this2.workService.presentToast(res.message);
              }
            }, function (err) {
          ...
          value: function openChat(event) {
            ...
            this.restService.remove_matchAPI(ss).subscribe(function (res) {
              ...
              if (res.status.success) {
                ...
                _this3.matches.splice(_this3.selectedIndexToDelete, 1);

                _this3.totalMatches = _this3.totalMatches - 1;
              } else {
                _this3.workService.presentToast(res.message);
              }
            }, function (err) {
          ...
          value: function ionViewWillEnter() {
            ...
            this.restService.getBestMatchesAPI(data).subscribe(function (res) {
              ...
              if (res.status == 'success') {
                _this4.matches = res.data;
                _this4.totalMatches = _this4.matches.length;
              } else {
                _this4.workService.presentToast('No Match Found');
              }
            }, function (err) {
              _this4.workService.hideLoading();
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "ion-col {\n  padding: 0px;\n}\n\n.btn {\n  background: #172A36 0% 0% no-repeat padding-box;\n  font-size: 14pt;\n  box-shadow: 0px 4px 10px #0000001f;\n  border-radius: 10px;\n  opacity: 1;\n  width: 100%;\n  padding-top: 16px;\n  padding-bottom: 16px;\n  color: #ffffff;\n}\n\n.btn_disable {\n  background: #172A36 0% 0% no-repeat padding-box;\n  color: #ffffff;\n  font-size: 14pt;\n  box-shadow: 0px 4px 10px #0000001f;\n  border-radius: 10px;\n  opacity: 1;\n  width: 100%;\n  padding-top: 16px;\n  padding-bottom: 16px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
