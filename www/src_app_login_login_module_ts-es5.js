  ...
  (self["webpackChunklev"] = self["webpackChunklev"] || []).push([["src_app_login_login_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _LoginPage = /*#__PURE__*/function () {
        function LoginPage(router, restService, workService, location, platform) {
          var _this = this;
        ...
        _createClass(LoginPage, [{
          ...
          value: function goToOTP() {
            ...
            if (this.countryCode == '') {
              ...
              setInterval(function () {
                _this2.phoneNumStatus = false;
                _this2.countryCodeStatus = false;
              }, 4000);
              ...
              this.restService.loginAPI(stringy).subscribe(function (res) {
                ...
                if (res.status == "success") {
                  if (res.data.status == "Active") {
                    ...
                    localStorage.setItem('packages_id', res.data.users_customers_id.packages_id); // localStorage.set('loggedinUserData', JSON.stringify(res.data.user))
                    // localStorage.setItem('loggedinUserID', res.data.user.users_customers_id)

                    _this2.router.navigate(['loginotp']);
                  } else if (res.data.status == "Pending") {
                    _this2.workService.presentToast('Your application is under review by the admin.');
                  } else if (res.data.status == "Inactive") {
                    _this2.workService.presentToast('Your login is temporary disabled. Please contact our team for further information.');
                  } else if (res.data.status == "Rejected") {
                    _this2.workService.presentToast('Your application is rejected by the admin. You can try applying again.');
                  } else if (res.data.status == "Deleted") {
                    _this2.workService.presentToast('Your application is deleted. Please contact our team for further information.');
                  } else {
          ...
          key: "phoneNumChaneg",
          value: function phoneNumChaneg(val) {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = ".inp {\n  padding: 10px;\n  background: #2d2d39;\n  box-shadow: 0px 4px 10px #0000001f;\n  border-radius: 8px;\n  opacity: 1;\n}\n\n.sc-ion-input-md-h {\n  --padding-top: 13px;\n  --padding-end: 13px;\n  --padding-bottom: 13px;\n  --padding-start: 13px;\n  font-size: inherit;\n}\n\n.sc-ion-input-ios-h {\n  --padding-top: 13px;\n  --padding-end: 13px;\n  --padding-bottom: 13px;\n  --padding-start: 13px;\n  font-size: inherit;\n}\n\n.btn {\n  background: #ffffff 0% 0% no-repeat padding-box;\n  color: black;\n  font-size: 14pt;\n  box-shadow: 0px 4px 10px #0000001f;\n  border-radius: 7px;\n  opacity: 1;\n  width: 100%;\n  padding-top: 16px;\n  padding-bottom: 16px;\n  height: 40pt;\n}\n\np {\n  display: block;\n  -webkit-margin-before: 0.5em;\n          margin-block-start: 0.5em;\n  -webkit-margin-after: 0em;\n          margin-block-end: 0em;\n  -webkit-margin-start: 0px;\n          margin-inline-start: 0px;\n  -webkit-margin-end: 0px;\n          margin-inline-end: 0px;\n}\n\n.redclass {\n  color: red;\n}\n\n.redBorder {\n  border: 1px solid red;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
