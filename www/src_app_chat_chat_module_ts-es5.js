    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _ChatPage = /*#__PURE__*/function () {
        ...
        _createClass(ChatPage, [{
          ...
          value: function gotootherProfile() {
            var _this11 = this;
            ...
            this.restService.get_user_dataAPI(data).subscribe(function (res) {
              _this11.workService.hideLoading();

              console.log('incomming data ===333333333 ', res);

              if (res.status == "success") {
                _this11.workService.myUserData = res;
                _this11.userData = _this11.workService.myUserData.data.user_data;
                localStorage.setItem('userNotiStatus', _this11.workService.myUserData.data.user_data.notification_switch);

                _this11.router.navigate(['viewprofileother']);
              }
            }, function (err) {
              _this11.workService.hideLoading();

              _this11.workService.presentToast('Network error occured');
            });
          }
        }]);
