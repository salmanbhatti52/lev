  ...
  (self["webpackChunklev"] = self["webpackChunklev"] || []).push([["src_app_otp_otp_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      _OtpPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _otp_routing_module__WEBPACK_IMPORTED_MODULE_0__.OtpPageRoutingModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _OtpPage = /*#__PURE__*/function () {
        function OtpPage(location, router, restService, workService) {
        ...
        _createClass(OtpPage, [{
          ...
          value: function ngOnInit() {
            this.phoneNumber = localStorage.getItem('phone'); // this.otp = '85296354'
          ...
          value: function goToProfile1() {
            ...
            if (this.otp1 != '' && this.otp2 != '' && this.otp3 != '' && this.otp4 != '' && this.otp5 != '' && this.otp6 != '') {
              ...
              this.otpConfrimResult.confirm(this.newOtp).then(function (data) {
                ...
                _this.router.navigate(['profile1']);
              }).then(function (res) {
                console.log('Verify error', res);

                _this.workService.presentToast('Incorrect OTP');
              });
            } else {
      ...
      _OtpPage = (0, tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
        selector: 'app-otp',
