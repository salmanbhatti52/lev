...
export class Yourprofile2Page implements OnInit {
  ...
  nationalityshow: boolean = true
  whatyoudoShow: boolean = true

  nationalityStatus: boolean = false
  phoneNumStatus: boolean = false
  genderStatus: boolean = false
  lookingForStatus: boolean = false
  heightStatus: boolean = false
  workplaceStatus: boolean = false

  whatyoudoStatus: boolean = false
  eduStatus: boolean = false
  schoolStatus: boolean = false

  careerStatus: boolean = false

  religionStatus: boolean = false
  affiliationStatus: boolean = false
  meritalStatusStatus: boolean = false
  relocateStatus: boolean = false
  personalityTypeStatus: boolean = false

  kosherStatus: boolean = false
  ethnicityStatus: boolean = false



  workPlaceshow: boolean = true
  eduStatusShow: boolean = true
  affiliationshow: boolean = true
  relocateshow: boolean = true
  personalityTypeshow: boolean = true
  ...
  selectedNat: any = 'Please Select'
  edu: any = 'Please Select'
  gender: any = 'Please Select'
  lookingFor: any = 'Please Select'
  religion: any = 'Please Select'
  meritalStatus: any = 'Please Select'
  affiliation: any = 'Please Select'
  personalityType: any = 'Please Select'
  relocate: any = 'Please Select'


  showPleaseSelectEthnicity: any = false
  ...
  personalityTypeArr: any = ''

  flagsList: any = ''


  YesNoArr = [{ id: 1, name: 'Yes' }, { id: 1, name: 'No' }]


  img1SelectedFromCamera1 = ''
  img2SelectedFromCamera2 = ''
  imgArr = [{ id: 0, img: 'assets/imgs/chose_img.svg' }, { id: 1, img: 'assets/imgs/chose_img.svg' }]
  coverImg: any = ''
  ...
  kosher: any = 'Please Select'

  ethnicity: any = 'Please Select'

  ethnicityArray: any = ''


  usercalculatedHeight = 'Enter Height'
